...
public class Magpie4
{
    ...
    private String transformIWantToStatement(String statement)
    {
        ...
        if (findKeyword(statement, "to") >= 0)
        {
            ...
            String objectAfterWant = statement.substring(psn + 6).trim();
            return "Would you really be happy if you had " + objectAfterWant + "?";
        }
    }
    ...
    //This method response to "I something you" statement
